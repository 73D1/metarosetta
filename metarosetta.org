...
***** Helper Functions
A couple of functions dealing with common actions shared across all connector methods.
...
****** Search for Section Ending Boundary
Get the point of the end of the narrowest section at point in context of the current buffer.

#+NAME: mrosetta-out-to-structured-text-section-end-position
#+BEGIN_SRC emacs-lisp :tangle yes
...
** Load and Save Metarosetta State
