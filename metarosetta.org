...
#+RESULTS: config-save
| (lambda nil (mrosetta-context-org-save mrosetta-context-org-default)) | org-id-locations-save | org-babel-remove-temporary-directory | recentf-save-list | recentf-cleanup | save-place-kill-emacs-hook | transient-maybe-save-history | flycheck-global-teardown | doom-cleanup-project-cache-h | savehist-autosave | persp-kill-emacs-h | doom-persist-scratch-buffers-h | server-force-stop |
