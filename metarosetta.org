...
#+BEGIN_SRC emacs-lisp :session mrosetta-config
(map! :leader
      :prefix ("M" . "Metarosetta")
      :desc "Start Metarosetta listener"
      :n "S" (cmd! (mrosetta-context-org-start-listening mrosetta-context-org-default
                                                         "laptop.btedeschi.com"
                                                         9000)))
"Keymap added!"
#+END_SRC

#+RESULTS: config-listener-start
: Keymap added!
...
(map! :leader
      :prefix ("M" . "Metarosetta")
      :desc "Stop Metarosetta listener"
      :n "s" (cmd! (mrosetta-context-org-stop-listening mrosetta-context-org-default)))
"Hook added!"
#+END_SRC

#+RESULTS: config-listener-stop
: Hook added!
...
#+RESULTS: config-listener-stop-remove
: Hook removed!
...
** Add HTTP Degug Proxy
Set a debugging http proxy to monitor outgoing http requests.

#+NAME: config-http-proxy
#+BEGIN_SRC emacs-lisp :session mrosetta-config
