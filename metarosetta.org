...
#+BEGIN_SRC emacs-lisp
(literally 'mrosetta-parse-literal)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
(WORD 'mrosetta-parse-word-uppercase)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
(Word 'mrosetta-parse-word-capitalized)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
(with 'mrosetta-parse-word-content)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
(prefixed 'mrosetta-parse-word-prefix)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
(suffixed 'mrosetta-parse-word-suffix)
#+END_SRC
